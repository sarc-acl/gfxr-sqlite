...
#ifndef  GFXRECON_GENERATED_VULKAN_SQLITE_CONSUMER_H
#define  GFXRECON_GENERATED_VULKAN_SQLITE_CONSUMER_H

#include "decode/vulkan_sqlite_consumer_base.h"
...
class VulkanSqliteConsumer : public VulkanSqliteConsumerBase
{
  public:
    VulkanSqliteConsumer(sqlite3* db) : VulkanSqliteConsumerBase(db) { }

    virtual ~VulkanSqliteConsumer() override { }
    ...
    virtual void Process_vkEnumerateInstanceExtensionProperties(
        ...
        StructPointerDecoder<Decoded_VkExtensionProperties>* pProperties) override;
    ...
    virtual void Process_vkEnumerateInstanceLayerProperties(
        ...
        VkResult                                    returnValue,
        PointerDecoder<uint32_t>*                   pPropertyCount,
        StructPointerDecoder<Decoded_VkLayerProperties>* pProperties) override;
    ...
    virtual void Process_vkEnumerateInstanceVersion(
        const ApiCallInfo&                          call_info,
        VkResult                                    returnValue,
        PointerDecoder<uint32_t>*                   pApiVersion) override;
...
#endif // GFXRECON_GENERATED_VULKAN_SQLITE_CONSUMER_H
